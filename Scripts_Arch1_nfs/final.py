...
from analyze import analyze, train, predict
from analyze2 import train1, train2, train3, train4
#NORMALIZATION
...
prediction = pd.DataFrame(predictions, columns=['predictions']).to_csv('prediction_day1_rogongon.csv')
