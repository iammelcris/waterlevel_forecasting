...
series = pd.DataFrame(series, columns=['DATETIME','DATE','TIME', 'WATERLEVEL', 'RF_DIGKILAAN', 'RF_ROGONGON'])
series = series.drop(['RF_ROGONGON', 'RF_DIGKILAAN'], axis=1)
series = series[['WATERLEVEL','DATE','TIME']]
print("Normalized: ")
